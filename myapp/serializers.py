...
class RegistroSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        extra_kwargs = {
            ...
            'denominacion_de_objeto_tecnico_1': {'required': False, 'allow_null': True},
            'campo_clasificacion': {'required': False, 'allow_null': True},
            'fabricante': {'required': False, 'allow_null': True},
            'inicio_garantia': {'required': False, 'allow_null': True},
            'fin_garantia': {'required': False, 'allow_null': True},
            'tipo_objeto': {'required': False, 'allow_null': True},
            'ubicacion_tecnica_2': {'required': False, 'allow_null': True},
            'indicador_abc': {'required': False, 'allow_null': True},
            'equipo_1': {'required': False, 'allow_null': True},
            'punto_medida': {'required': False, 'allow_null': True},
            'documento_medicion': {'required': False, 'allow_null': True},
            'ubicacion_tecnica_3': {'required': False, 'allow_null': True},
            'deno_punto_medida': {'required': False, 'allow_null': True},
            'criticidad': {'required': False, 'allow_null': True},
            'fecha_criticidad': {'required': False, 'allow_null': True},
            'aviso_criticidad': {'required': False, 'allow_null': True},
            'creador_por': {'required': False, 'allow_null': True},
            'denominacion_de_objeto_tecnico_2': {'required': False, 'allow_null': True},
            'hora_medicion': {'required': False, 'allow_null': True},
        }
